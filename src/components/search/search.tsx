...
export const Search = () =>{
    ...
    return(
        ...
        <form onSubmit={handleSearch} className="relative group ">
            ...
            rounded-md text-body-sm outline-none transition-all duration-200 focus:border-blue-300
            focus:ring-1 focus:ring-blue-300 placeholder:text-gray-300 placeholder:text-body-sm" />
        </form>
        </>
    )
}

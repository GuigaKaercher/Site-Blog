...
export const HeroSection = () => {
    return(
        <section className=" container relative flex items-center justify-center mt-16 pt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
                ...
                lg:items-start ">
                    ...
                    <div className="
                    text-white flex flex-col gap-2 mt-5 items-center 
                    md:items-start lg:items-start">
                    ...
                    <div className="relative h-[20rem] hidden md:h-full order-first md:order-last items-center
                    justify-center md:flex lg:flex">
                        <Image 
                        src='/hero-section.png'
                        alt="Ilustração com icones"
                        height={400}
                        width={200}
